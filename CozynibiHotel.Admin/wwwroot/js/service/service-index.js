...
$(document).ready(async function () {
    ...
    var CATEGORY_IMG_SRC = GET_IMAGE_URL + "service"
    var cateList = [];
    var RECORD_ID = 0;
    //GET TOKEN
                ...
                `
								...
								<td class="table-report__action w-56">
									<div class="flex justify-center items-center">
										<a class="flex items-center mr-3 btn-edit" style="cursor:pointer;" data-cate-id="${cate.id}" onclick="window.location.href='/Admin/Service/Edit/${cate.id}';">
    ...
    $("#delete-confirmation-modal .btn-remove ").click(async function () {
        const PUT_RECORD = HOST + "/api/Service/" + RECORD_ID +"/" +true;
        var formData = new FormData();
        formData.append("serviceId", RECORD_ID);
